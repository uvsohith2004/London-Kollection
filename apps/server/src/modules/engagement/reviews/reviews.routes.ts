...
import { CreateReviewSchema, ModerateReviewSchema } from "./reviews.validate"
...
adminReviewsRouter.patch("/:id/moderate", zValidator("json", ModerateReviewSchema), (c) => controller.moderateReview(c))
