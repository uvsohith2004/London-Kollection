              ...
              <div className="sticky top-8 bg-card rounded-2xl p-6 md:p-8 border border-border/50 shadow-sm">
                ...
                <div className="space-y-3 text-sm mb-6">
                  <div className="flex justify-between text-muted-foreground">
                    <span>Subtotal</span>
                    <span><Price amount={preview?.subtotal ?? cartSummary?.subtotal ?? 0} /></span>
                  </div>
                  <div className="flex justify-between text-muted-foreground">
                    <span>Shipping</span>
                  ...
                  <div className="flex justify-between text-muted-foreground">
                    ...
                    <span><Price amount={preview?.taxTotal ?? 0} /></span>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-end mb-6">
                  ...
                  <div className="text-right">
                    <Price amount={preview?.grandTotal ?? cartSummary?.grandTotal ?? 0} className="font-bold text-3xl text-foreground" />
                  </div>
                </div>
