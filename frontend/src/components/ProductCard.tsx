          ...
          {!outOfStock && (
            <div className="grid grid-cols-2 gap-2 sm:gap-3 pt-3">
              <button
                ...
                className="rounded border-2 border-black bg-white px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm font-semibold text-black transition duration-200 active:bg-gray-100 hover:bg-gray-50"
              >
                Add to Cart
              </button>
              <button
                onClick={handleBuyNow}
                className="rounded bg-black px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm font-semibold text-white transition duration-200 active:bg-gray-900 hover:bg-stone-900"
              >
                Buy Now
              </button>
            </div>
