      ...
      <form onSubmit={handleSubmit} className="grid gap-16 lg:grid-cols-3">
        ...
        <div className="sticky top-24 h-fit rounded-3xl border border-gray-200 p-10">
          ...
          <button
            ...
            className="mt-10 flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 py-4 text-sm text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-70"
          >
          ...
          <a
            ...
            className="mt-4 block w-full rounded-xl border border-blue-600 py-3 text-center text-sm transition hover:bg-blue-50 text-blue-600 font-medium"
          >
