  ...
  if (items.length === 0) {
    return (
      <div className="container py-28 text-center">
        ...
        <Link
          to="/shop"
          className="bg-blue-600 hover:bg-blue-700 text-white font-body text-sm uppercase tracking-wider px-10 py-3 rounded-full inline-flex items-center gap-3 transition"
        >
    ...
    <div className="container py-16">
      ...
      <div className="grid lg:grid-cols-3 gap-14">
        ...
        <div className="bg-card rounded-2xl p-8 shadow-sm h-fit sticky top-24">
          ...
          <Link
            to="/checkout"
            className="mt-8 bg-blue-600 hover:bg-blue-700 text-white font-body text-sm uppercase tracking-wider px-10 py-3 rounded-full w-full inline-flex items-center justify-center gap-3 transition"
          >
